...
class WideResNetFunnel(nn.Module):

    def __init__(self, depth, k, n_out, bias=True):
        super(WideResNetFunnel, self).__init__()
        ...
        self.conv1 = nn.Conv2d(3, 32, kernel_size=(17, 17), padding=0, bias=bias)
        self.bn1 = nn.BatchNorm2d(32, momentum=0.001)
        #self.conv_group1 = ConvGroup(n_features[0], n_features[1], blocks=n, downsample=False, bias=bias)
        self.conv_group2 = ConvGroup(n_features[1], n_features[2], blocks=n, downsample=False, bias=bias)
